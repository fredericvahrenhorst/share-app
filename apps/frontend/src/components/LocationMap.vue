<template>
    ...
    >
        ...
        <div
            class="
            fixed z-50 bottom-28 right-2 w-10 h-10
            rounded-full
            flex items-center justify-center
            blur-bg-light text-blue-500
            "
            @click="getGeoLocation(true)"
        >
            <ion-icon aria-hidden="true" size="small" color="current" :icon="navigate" />
        </div>
        ...
        >
            ...
            >
                <template v-slot:icon>
                    <div class="w-4 h-4 rounded-full bg-blue-500 border-4 border-white shadow-lg"></div>
                </template>
            </mapbox-marker>
